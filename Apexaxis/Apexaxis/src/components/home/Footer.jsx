    ...
    <>
      <footer className="footer">
        <div className="main-footer">
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="#">
                  <i className="mail icon"></i>support@apexaxis.com
                </a>
              </li>
              <li>
                <a href="#">
                  <i className="globe icon"></i>ApexAxis.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="socials">
          <div>
            <a href="https://www.facebook.com/ApexAxis/" target="_blank" rel="noreferrer">
              <Icon name="facebook" size="large" color="blue" />
            </a>
          </div>
          <div>
            <a href="https://www.youtube.com/ApexAxis/" target="_blank" rel="noreferrer">
              <Icon name="youtube" size="large" color="red" />
            </a>
          </div>
          <div>
            <a href="https://twitter.com/ApexAxis" target="_blank" rel="noreferrer">
              <Icon name="twitter square" size="large" color="blue" />
            </a>
          </div>
          <div>
            <a href="https://www.instagram.com/ApexAxis/" target="_blank" rel="noreferrer">
      ...
      <div className="copyright">
        <hr />
        <p>&copy; 2024 ApexAxis. All rights reserved</p>
      </div>
    </>
  );
}
